        ...
        <div class="col-lg-6 col-md-8  col-sm-10 col-12 mx-auto">
            <div class="card surveyBoxSize scale-up-center  mt-md-5 mt-2">
                ...
                <div class="card-body" style="color:#333" id="page_6">
                    <form method="post" action="{{route('submitSurvey4')}}" class="surveyForms">
                        @csrf
                        ...
                        <div class="nextSurvey">
                            <a href="{{route('skipSurveyQuestion','page_6')}}" class="skipSurveyQuestion btn btn-sm btn-default" style='color:#666!important'>skip</a>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDGiWgz4aetTJfxhPDlO87LPMS3BtYdM_Y&libraries=places&callback=initMap"
async defer></script>
@endpush
