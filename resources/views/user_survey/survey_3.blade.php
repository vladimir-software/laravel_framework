            ...
            <div class="card surveyBoxSize scale-up-center my-2"> 
                ...
                <div class="card-body " style="color:#333" id="page_5"> 
                    ...
                    <div id="categoryContainer" style="display:none;">
                        <label class="form-check-label suveyLabel mt-3" for="defaultCheck1">Please select a category</label>
                        <div>
                            ...
                            <div class="hideSubCat" style="display:none;">
                                <label class="form-check-label suveyLabel" for="defaultCheck1">Please select a sub category</label>
                                <div class="input-group">                                       
                        ...
                        <div class="nextSurvey mb-3">
                            <a href="{{route('skipSurveyQuestion','page_5')}}" class="skipSurveyQuestion btn btn-sm btn-default" style='color:#666!important'>skip</a>
                    ...
                    <form method="post" action="{{route('submitSurvey3')}}" class="surveyForms" id="categoryForm">
                        @csrf 
                        <input name="other" hidden="" value="" class="otherValue"> 
                        <label class="form-check-label suveyLabel mt-3 surveyLabelColor" for="defaultCheck1">{{$pageData[1]['content']}}</label>
                        <div class="input-group">
                        ...
                        <label class="form-check-label suveyLabel  mt-3 surveyLabelColor"  for="defaultCheck1">{{$pageData[0]['content']}}</label>
                        <div class="input-group">    
                        ...
                        <label class="form-check-label suveyLabel mt-3 surveyLabelColor" for="defaultCheck1">{{$pageData[2]['content']}}</label>
                        <input hidden="" value="Describe your product in detail" name="question" >
                        <textarea class="form-control"  onkeyup="countTitle(this)" max-length="300" rows="3" name="answer" value="{{$data['answer']}}" required="required">{{$data['answer']}}</textarea>
...
<script>
    ...
    $(".setSubCategory").on('change', function (e) {
        var catIds = $(".setSubCategory  option:selected").val();
