...
<div class="container moreObtainMatches" id="connection">
    <div class="row my-5">
        <div class="col-sm-12"><h2 class="text-center">Collaboration Matches</h2></div>
        @if(count($usersForCollaboration) < 1)
            <br/><br/><br/>
            <div class="col-sm-12"><h5 class="text-center"><i class="far fa-clock"></i> Please Check back later for more matches...</h5></div>
        @endif
        @if(count($usersForCollaboration) >=1)
        @php $i=1;@endphp
        @foreach($usersForCollaboration as $key=>  $data) 
                ...
                <div class="card-body p-0  userRating d-flex flex-column">                   
                    <div class="text-center  py-3">
                        ...
                        <div class="pt-4 userConnectionDataContainer">
                            ...
                            <div><span style="color:#000">Collaboration Opportunity</span>                                                   
                                <div class="owl-carousel-collaboration-more owl-carousel">
                            ...
                            <div class="relationDetails">
                                ...
                                @php  $m="collaboration:".$c1.",".(isset($data['sub_cat_id'][$key])?$data['sub_cat_id'][$key]:''); @endphp    
...
<script>
    var owlss = $('.owl-carousel-collaboration-more');
    owlss.owlCarousel({
        autoplay: false,
        center: true,
        margin: 10,
