...
<div class="container moreObtainMatches" id="connection">
    <div class="row my-5">
        <div class="col-sm-12"><h2 class="text-center">Businesses You Need</h2></div>
                    ...
                    <div class="text-center  py-3">
                        ...
                        <div class="pt-4 userConnectionDataContainer">
                            ...
                            <div><span style="color:#000">You Need Them</span>                                                   
                                <div class="owl-carousel-find-more owl-carousel">
                            ...
                            <div class="relationDetails">
                                ...
                                @foreach($data['cat_id'] as $key1=>$c1)
                                @php  $m="obtain:".$c1.",".(isset($data['sub_cat_id'][$key])?$data['sub_cat_id'][$key]:''); @endphp       
...
<script>
    var owlss = $('.owl-carousel-find-more');
    owlss.owlCarousel({
        autoplay: false,
        center: true,
        margin: 10,
