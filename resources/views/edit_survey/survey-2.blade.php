            ...
            <div class="col-lg-6 col-md-8 col-sm-10 col-12 mx-auto">
                <div class="card surveyBoxSize scale-up-center mt-2"> 
                    ...
                    <div class="card-body" style=";color:#333" id="page_3">
                        <form method="post" action="{{route('submitEditedSurvey2')}}" class="surveyForms">
                            @csrf
                            ...
                            <div class="nextSurvey">
                                <a href="{{route('skipEditSurveyQuestion','page_3')}}" class="skipSurveyQuestion btn btn-sm btn-default" style='color:#666!important'>skip</a>
